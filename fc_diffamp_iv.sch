...
C {madvlsi/gnd.sym} -240 -140 0 0 {name=l6 lab=GND}
...
C {devices/lab_pin.sym} -240 -200 1 0 {name=p3 sig_type=std_logic lab=V2
}
...
C {devices/lab_pin.sym} 240 -290 2 0 {name=p13 sig_type=std_logic lab=Vout
}
C {madvlsi/tt_models.sym} 300 -400 0 0 {
name=TT_MODELS
only_toplevel=false
...
C {madvlsi/vsource.sym} -310 -200 0 0 {name=V3
value=0.9}
C {madvlsi/gnd.sym} -310 -170 0 0 {name=l10 lab=GND}
C {devices/lab_pin.sym} -310 -230 1 0 {name=p15 sig_type=std_logic lab=Vout
}
C {devices/ammeter.sym} 240 -320 0 0 {name=Vmeas}
